...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'AFILIAR_SOCIO')
    DROP PROCEDURE AFILIAR_SOCIO;
GO
...
BEGIN
	...
	INSERT INTO SOCIO (NUM_DOC_SOCIO, NOMBRE, CUPO_DISPONIBLE , FONDOS_DISPO, ID_TIPO_SUB)
	VALUES (@NUMERO_DOC_SOCIO,@NOMBRE_SOCIO,@FONDOS_INICIALES,@FONDOS_INICIALES,(SELECT ID_TIPO_SUB FROM TIPO_SUBSCRIPCION WHERE TIPO=@TIPO_SUBSCRIPCION))
